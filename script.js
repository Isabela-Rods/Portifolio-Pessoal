...
//Função para alternar entre os temas claroe escuro
function toggleMode(){
...
//Carrega o tema saldo no localStorage ao carregar a página
...
//====================== Animação do Título ====================
//Seleciona o elmento do título e define variáveis para a animação
const titleElement = document.querySelector('#name');
const text = "ISABELA RODRIGUES";
let index = 0;
let isTyping = true;
let currentColor = document.documentElement.classList.contains('light') ? 'black' : '#ffffff';
...
function animateText(){
    if (isTyping) {
        ...
        if(index > 1){
            ...
            currentColor = currentColor === (document.documentElement.classList.contains ('light') ? 'black' : '#fff') ? '#7757b7' : (document.documentElement.classList.contains ('light') ? 'black' : '#fff');
